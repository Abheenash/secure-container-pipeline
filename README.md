...
- [ ] **Stage 0** — Repo, reuse account hygiene (IAM admin + MFA, budget alarm), **GitHub OIDC deploy role**, ECR repo, local tooling (Docker, Terraform, `gh`)
- [ ] **Stage 1** — Containerize a minimal API (FastAPI + DynamoDB); run locally; push to ECR by hand
